...
1. **README.md** (본 문서) — 프로젝트 개요, 파이프라인, 설계 이유
2. **일일보고_연구일지_김민수_2026_01_29.md** — 오늘까지 진행·결과·다음 단계
3. **일일보고_연구일지_2026_01_29_예상QA.md** — 코드·설계 관련 예상 질문과 답변
4. **21번 ~ 26번 스크립트** — 실행 순서대로 코드 흐름 설명  
상세 가이드(Colab 설정 등)는 **docs/** 폴더.
...
자세한 질문·답변은 **일일보고_연구일지_2026_01_29_예상QA.md** 참고.
...
*최종 업데이트: 2026-01-29. 일일보고·예상 Q&A와 동기화.*
